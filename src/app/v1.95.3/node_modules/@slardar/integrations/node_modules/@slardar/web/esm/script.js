    ...
    if (browserClient.p) {
        ...
        if (precollect_1) {
            browserClient.provide('precollect', function () {
                ...
                log.apply(void 0, __spreadArray(['[script] keep pushing precollected data for other instances'], __read(args), false));
...
export default browserClient;//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/integrations/node_modules/@slardar/web/esm/script.js.map