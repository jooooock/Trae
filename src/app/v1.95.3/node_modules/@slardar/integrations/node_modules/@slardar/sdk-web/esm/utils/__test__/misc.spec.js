...
import { invokeCallbackOnce, addListenerToDocument, addListenerToWindow, onceHidden, onPageLoad, onPageUnload, getConfig, onPageNextShow, } from '../misc';
...
test.serial('addListenerToWindow - window', function (t) {
    ...
    window.dispatchEvent(new window.Event('load'));
    t.assert(cb.calledTwice);
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/integrations/node_modules/@slardar/sdk-web/esm/utils/__test__/misc.spec.js.map