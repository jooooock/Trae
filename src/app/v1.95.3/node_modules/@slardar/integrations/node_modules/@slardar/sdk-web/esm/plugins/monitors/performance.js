...
export function PerformanceMonitorPlugin(client) {
    client.on('init', function () {
        ...
        applyMonitor(PerformanceMonitor, __assign(__assign({}, config), { precollect: precollect }), reportWithCurrentContext(client));
        var sendPrefMetric = function (metric) {
            client.report({ ev_type: PERFORMANCE_METRIC_EV_TYPE, payload: metric });
        };
        // spa_load
        ...
        if (config.longtask) {
            var sendPerformanceLongtask = function (longtaskPayload) {
                client.report({ ev_type: LONG_TASK_EV_TYPE, payload: longtaskPayload });
            };
        ...
        if (config.cls) {
            ...
            var sendCLS = function (metric) {
                client.report({ ev_type: PERFORMANCE_METRIC_EV_TYPE, payload: metric, overrides: { url: originUrl_1 } });
            };
...
}//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/integrations/node_modules/@slardar/sdk-web/esm/plugins/monitors/performance.js.map