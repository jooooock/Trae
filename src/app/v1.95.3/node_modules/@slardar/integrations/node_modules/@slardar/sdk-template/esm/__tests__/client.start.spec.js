...
test('client.start - trigger callback, in order', function (t) {
    ...
    client.on('init', afterInit2);
    t.assert(afterInit2.calledTwice);
    t.notThrows(function () {
    ...
    client.on('start', afterStart2);
    t.assert(afterStart2.calledTwice);
    // no effect
    client.start();
    t.assert(afterStart2.called);
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/integrations/node_modules/@slardar/sdk-template/esm/__tests__/client.start.spec.js.map