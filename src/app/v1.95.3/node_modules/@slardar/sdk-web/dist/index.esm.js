...
var httpGetterWithXhrObserver = function (tearDownGroup, _a, xhrConfig) {
    ...
    tearDownGroup.push(xhrObserver[0](function (_a) {
        ...
        if (!_url || checkIfHit(ignoreUrls, _url))
            return noop;
