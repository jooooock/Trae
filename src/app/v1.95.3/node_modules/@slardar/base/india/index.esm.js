...
var createConfigManager = function (defaultConfig) {
    ...
    function updateConfig() {
        var newConfig = __assign(__assign({}, defaultConfig), userConfig);
        newConfig.sample = mergeSampleConfig(defaultConfig.sample, userConfig.sample);
        config = newConfig;
        onChange();
    }
};
...
var addEnvToSendEvent = function (ev, config) {
    var extra = {
        ...
        query: '',
        timestamp: Date.now(),
        sdk_version: config.version || SDK_VERSION,
        sdk_name: config.name || SDK_NAME,
    };
...
export { BATCH_REPORT_PATH, CustomPlugin, DEFAULT_SAMPLE_CONFIG, DEFAULT_SENDER_SIZE, InjectConfigPlugin, InjectEnvPlugin, REPORT_DOMAIN, SDK_NAME, SDK_VERSION, SETTINGS_DOMAIN, SETTINGS_PATH, addConfigToReportEvent, addEnvToSendEvent, builder, createBaseClient, createConfigManager, createMinimalClient, browserClient as default, getDefaultConfig, getDefaultDeviceId, getDefaultSessionId, getDefaultUserId, getReportUrl, getSettingsUrl, getViewId, mergeSampleConfig, normalizeInitConfig, normalizeUserConfig, validateInitConfig };//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/base/india/index.esm.js.map
