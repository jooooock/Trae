...
class AppBridge {
  ...
  onEventV3(event, params) {
    try {
      ...
      this.collect.emit(DebuggerMesssge.DEBUGGER_MESSAGE, {type: DebuggerMesssge.DEBUGGER_MESSAGE_EVENT, info: 'bridge埋点上报', time: Date.now(), data: [{events:[{event, params}]}], code: 200, status: 'success'})
    } catch(e) {
