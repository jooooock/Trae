...
const MULTI_ARCH_LINUX_VERSION = 'v10.2.0';// use this for arm-unknown-linux-gnueabihf and powerpc64le-unknown-linux-gnu until we can fix https://github.com/microsoft/ripgrep-prebuilt/issues/24 and https://github.com/microsoft/ripgrep-prebuilt/issues/32 respectively.
...
async function main() {
  ...
  try {
    ...
    console.error(`Downloading fd failed: ${err.stack}`);
    process.exit(1);
  }
}
