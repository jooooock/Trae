...
test('sampler - user hit', function (t) {
    var destroyFn = sinon.fake();
    var destroySingleTypeFn = sinon.fake();
    var sampler = getSampler('hituser', {
        sample_rate: 0,
        sample_granularity: 'session',
        include_users: ['hituser'],
        rules: {},
    }, function () { return false; }, function () { return false; }, [destroyFn, destroySingleTypeFn]);
    t.deepEqual(sampler(__assign({}, ev)), __assign(__assign({}, ev), { common: {
            sample_rate: 1,
        } }));
    t.assert(destroyFn.notCalled);
    t.assert(destroySingleTypeFn.notCalled);
});
test('sampler - base rate', function (t) {
    ...
    var sampler = getSampler('user', config, function () { return true; }, function () { return true; }, [destroyFn, destroySingleTypeFn]);
    t.deepEqual(sampler(__assign({}, ev)), __assign(__assign({}, ev), { common: {
            sample_rate: 0.3,
        } }));
    t.assert(destroyFn.notCalled);
    t.assert(destroySingleTypeFn.notCalled);
    t.falsy(getSampler('user', config, function () { return false; }, function () { return false; }, [destroyFn, destroySingleTypeFn])(__assign({}, ev)));
    t.assert(destroyFn.calledOnce);
    t.assert(destroySingleTypeFn.notCalled);
});
test('sampler - ev_type not configed', function (t) {
    ...
    var sampler = getSampler('user', {
        ...
        include_users: [],
        rules: {},
    }, function () { return true; }, function () { return true; }, [destroyFn, destroySingleTypeFn]);
    t.deepEqual(sampler(__assign({}, ev)), __assign(__assign({}, ev), { common: {
            sample_rate: 0.6,
        } }));
    t.assert(destroyFn.notCalled);
...
test('sampler - ev_type disabled', function (t) {
    ...
    t.falsy(sampler(ev));
    t.assert(destroyFn.notCalled);
    t.assert(destroySingleTypeFn.calledOnce);
});
...
test('sampler - ev_type conditional rate', function (t) {
    ...
    t.assert(destroyFn.notCalled);
    t.assert(destroySingleTypeFn.notCalled);
    t.falsy(getSampler('user', config, function () { return false; }, function () { return false; }, [destroyFn, destroySingleTypeFn])(ev));
    t.assert(destroyFn.calledOnce);
    t.assert(destroySingleTypeFn.notCalled);
});
...
test('sampler -  not total sample and ev_type condition not matched', function (t) {
    var destroyFn = sinon.fake();
    var destroySingleTypeFn = sinon.fake();
    var config = {
        sample_rate: 1,
    ...
    t.assert(destroyFn.notCalled);
    t.assert(destroySingleTypeFn.notCalled);
    t.falsy(getSampler('user', config, function (k) {
        if (k === 1)
            return true;
        return false;
    }, function (_r, k) {
        if (k === 1)
            return true;
        return false;
    }, [destroyFn, destroySingleTypeFn])(ev));
    t.assert(destroyFn.notCalled);
    t.assert(destroySingleTypeFn.notCalled);
});
test('sampler - ev_type condition prioritized', function (t) {
    ...
    var sampler = getSampler('user', config, function () { return true; }, function () { return true; }, [noop, noop]);
    t.deepEqual(sampler(__assign({}, ev)), __assign(__assign({}, ev), { common: {
            sample_rate: 0.005,
        } }));
});
...
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/sdk-web/esm/plugins/__test__/sample.spec.js.map