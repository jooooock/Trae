import { checkIfHit } from '@slardar/sdk-template';
import { HTTP_EV_TYPE, RESOURCE_EV_TYPE, RESOURCE_ERROR_EV_TYPE } from '../../constants';
 ...
 */
export var waitActionComplete = function (win, cb, forceClear, maxTimeOut) {
    var idleTimer;
    var maxIdleTimer;
    var started = false;
    var notify = function () {
...
export var shouldIgnoreUrl = function (ignoreUrls, url) {
    return !!(ignoreUrls && ignoreUrls.length && url && checkIfHit(ignoreUrls, getFullUrl(url)));
};
export var shouldIgnoreEvent = function (ignoreUrls, ev) {
    var url;
...
};//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/sdk-web/esm/monitors/action/util.js.map