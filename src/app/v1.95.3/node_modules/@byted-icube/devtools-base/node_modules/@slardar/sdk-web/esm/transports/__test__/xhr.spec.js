...
test.serial('xhrTransport - status < 200 || status >= 300', function (t) {
    var xhr = sinon.useFakeXMLHttpRequest();
    // @ts-expect-error
    global.XMLHttpRequest = xhr;
    var requests = [];
    ...
    requests[0].respond(500, {}, JSON.stringify(mockError));
    t.assert(onSuccess.notCalled);
    t.assert(onFail.calledOnce);
    t.assert(onFail.args[0][0].message, JSON.stringify(mockError));
    xhr.restore();
    // @ts-expect-error
    global.XMLHttpRequest = undefined;
});
...
test.serial('xhrTransport - error', function (t) {
    ...
    // @ts-expect-error
    global.XMLHttpRequest = undefined;
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/sdk-web/esm/transports/__test__/xhr.spec.js.map