...
import { getDefaultDeviceId, getDefaultSessionId, getDefaultUserId, getReportUrl, getSettingsUrl } from '../util';
...
test.serial('getDefaultUserid', function (t) {
    t.assert(getDefaultUserId());
});
test.serial('getDefaultDeviceid', function (t) {
    t.assert(getDefaultDeviceId());
});
test('getDefaultSessionId', function (t) {
    t.assert(getDefaultSessionId());
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/base/esm/__test__/util.spec.js.map