...
import { getGetLatestEntryByName, handleWithExtractUrl } from '../http/util';
...
test('handleWithExtractUrl should work', function (t) {
    var originalUrl = 'http://example.com/123';
    var timing = {
        name: originalUrl,
        toJSON: function () {
            return {
    ...
    handleWithExtractUrl(httpPayload);
    t.is(httpPayload.request.url, originalUrl);
    t.falsy(httpPayload.extra);
    var extractUrl = function (url) {
        var regex = /\/\d+\/?/;
        return url.replace(regex, '/:id');
    };
    handleWithExtractUrl(httpPayload, extractUrl);
    t.is(httpPayload.request.url, 'http://example.com/:id');
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/sdk-web/esm/monitors/__test__/http.spec.js.map