...
import { BATCH_REPORT_PATH, SETTINGS_PATH } from './constants';
...
export var getDefaultUserId = function () {
    return uuid();
};
export var getDefaultDeviceId = function () {
    return uuid();
};
export var getViewId = function (pid) { return pid + "_" + Date.now(); };
export var getDefaultSessionId = function () {
    return uuid();
};//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/base/esm/util.js.map