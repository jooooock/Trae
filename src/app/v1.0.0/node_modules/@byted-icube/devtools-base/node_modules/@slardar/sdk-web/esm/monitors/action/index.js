...
import { applyRecord, arrayIncludes, uuid, noop } from '@slardar/sdk-template';
import { JS_ERROR_EV_TYPE, HTTP_EV_TYPE, RESOURCE_EV_TYPE, LONG_TASK_EV_TYPE, ACTION_EV_TYPE, PAGEVIEW_EV_TYPE, RESOURCE_ERROR_EV_TYPE, } from '../../constants';
import { htmlTreeAsString, applyPerformance, applyMutationObserver, now as absoluteNow, addListenerToDocument, } from '../../utils';
import { waitActionComplete, getActionName, isValidTarget, DEFAULT_ATTR_NAME, shouldIgnoreUrl, shouldIgnoreEvent, } from './util';
 ...
 */
export var applyIncompleteReq = function (tearDownGroup, _a, notify, ignoreUrls) {
    ...
    tearDownGroup.push(xhrObserver[0](function (_a) {
        var _b = __read(_a, 2), _method = _b[0], _url = _b[1];
...
};//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/sdk-web/esm/monitors/action/index.js.map