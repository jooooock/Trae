...
import { AjaxMonitorPlugin } from '../ajax';
...
test.serial('AjaxMonitorPlugin - extraExtractor should work', function (t) {
    var target = {
        reqBody: 'req=123',
        resBody: JSON.stringify({ res: 'test' }),
    };
    var MockedXHR = createMockXHR({
        response: target.resBody,
    });
    window.XMLHttpRequest = MockedXHR;
    var client = createTestWebClient();
    var onReport = sinon.fake();
...
test.serial('destroyAgent should work with AjaxMonitorPlugin', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var MockedXHR, client, onReport, xhr, callArgs, xhr2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                MockedXHR = createMockXHR({
            ...
            case 1:
                ...
                client.destroyAgent.remove('ajax');
                xhr2 = new window.XMLHttpRequest();
                xhr2.open('GET', 'http://www.toutiao.com');
                client.config({
                    pid: 'third-pid',
...
}); });//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@byted-icube/devtools-base/node_modules/@slardar/sdk-web/esm/plugins/monitors/__test__/ajax.spec.js.map