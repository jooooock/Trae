...
test('mergeDeepCopyArray', function (t) {
    ...
    var pojo = { pojo: true };
    var target = { name: 'a', location: { country: 'cc' }, record: [1, 2, 3] };
    var source = { age: 16, location: { city: 'bb' }, record: [/TEST/, '1', '2', '3', pojo, foo] };
...
test('mergeDeepConcatArray', function (t) {
    ...
    var pojo = { pojo: true };
    var arr = [1, 2, 3];
    var target = { name: 'a', location: { country: 'cc' }, record: [1, 2, 3, a, arr] };
    var source = { age: 16, location: { city: 'bb' }, record: [/TEST/, 1, 2, 3, '1', '2', '3', pojo, foo, f, b] };
...
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/sdk-template/esm/utils/__tests__/object-array.spec.js.map