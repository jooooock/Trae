...
import { getDefaultPerformanceObserver, applyPerformanceObserver, onPageUnload, invokeCallbackOnce, addListenerToWindow, getDefaultBrowser, } from '../../../utils';
import { initMetric, onceHidden } from '../util';
...
export var LCPMonitor = function (PerformanceObserver) {
    ...
    return function (props, cb) {
        ...
        LCPListenerEventTypes.forEach(function (type) {
            addListenerToWindow(window, type, invokeCbAndStopListening, true);
        });
...
};//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/base/node_modules/@slardar/sdk-web/esm/monitors/performance/lcp-monitor/index.js.map