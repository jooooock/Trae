...
var observeKeypress = function (next, tearDown) {
    ...
    if (!document)
        return;
    document.addEventListener(KEYPRESS_EVENT_NAME, next, true);
    tearDown(function () {
        document.removeEventListener(KEYPRESS_EVENT_NAME, next, true);
    });
};
...
var HIDDEN_SUBJECT_NAME = 'hidden_2';
...
export { ACTION_EV_TYPE, ACTION_MONITOR_PLUGIN_NAME, AJAX_MONITOR_PLUGIN_NAME, ActionMonitorBasePlugin, ActionMonitorPlugin, AjaxMonitorPlugin, AjaxMonitorVolPlugin, BLANK_SCREEN_EV_TYPE, BLANK_SCREEN_MONITOR_PLUGIN_NAME, BREADCRUMB_MONITOR_PLUGIN_NAME, BlankScreenMonitorPlugin, BlankScreenMonitorVolPlugin, BreadcrumbMonitorPlugin, CUSTOM_EV_TYPE, CustomPlugin, DEFAULT_STORAGE_EXPIRES, DOMContentLoadSubject, DOM_CONTENT_LOAD_SUBJECT_NAME, FETCH_MONITOR_PLUGIN_NAME, FMPMonitorPlugin, FMP_MONITOR_PLUGIN_NAME, FetchMonitorPlugin, FetchMonitorVolPlugin, HEATMAP_EV_TYPE, HEATMAP_MONITOR_PLUGIN_NAME, HIDDEN_SUBJECT_NAME, HTTP_EV_TYPE, InjectNetworkTypePlugin, JS_ERROR_EV_TYPE, JS_ERROR_MONITOR_PLUGIN_NAME, JsErrorMonitorPlugin, LOAD_SUBJECT_NAME, LONG_TASK_EV_TYPE, PAGEVIEW_EV_TYPE, PAGEVIEW_MONITOR_PLUGIN_NAME, PERFORMANCE_METRIC_EV_TYPE, PERFORMANCE_MONITOR_PLUGIN_NAME, PERFORMANCE_TIMING_EV_TYPE, PageviewMonitorPlugin, PerformanceMonitorPlugin, RESOURCE_ERROR_EV_TYPE, RESOURCE_ERROR_MONITOR_PLUGIN_NAME, RESOURCE_EV_TYPE, RESOURCE_MONITOR_PLUGIN_NAME, ResourceErrorMonitorPlugin, ResourceMonitorPlugin, SESSION_EV_TYPE, SPALoadMonitorPlugin, SamplePlugin, TTIMonitorPlugin, TTI_MONITOR_PLUGIN_NAME, UNKNOWN_PATH, UNLOAD_SUBJECT_NAME, addListenerToDocument, addListenerToWindow, applyAnimationFrame, applyMonitor, applyMutationObserver, applyPerformance, applyPerformanceObserver$1 as applyPerformanceObserver, applyRequestIdleCallback, applyUpdate, captureCurrentContext, clearTimerWithTearDowns, createBatchSender, createBrowserSender, decodeWithBase64, defaultPerformancePrecollect, encodeToBase64, formatStorageExpires, getBeaconTransport, getConfig, getCurrentScript, getDefaultBrowser, getDefaultCaf, getDefaultDocument, getDefaultFetch, getDefaultHistory, getDefaultLocation, getDefaultMutationObserver, getDefaultNavigator, getDefaultNetworkInformation, getDefaultPerformance, getDefaultPerformanceObserver, getDefaultPerformanceTiming, getDefaultPromise, getDefaultRaf, getDefaultXMLHttpRequest, getFullUrl, getGlobalRegistry, getLocationUrl, getNetworkType, getPluginConfig, getSampler, getStorageWithDecoding, getViewId, getXhrTransport, hiddenSubject, htmlTreeAsString, invokeCallbackOnce, isSupportEncrypt, loadScript, loadSubject, normalizeCustomEventData, normalizeCustomLogData, normalizeUnknownError, now, observeDOMContentLoad, observeHidden, observeLoad, observeUnload, onPageLoad, onPageNextShow, onPageUnload, onceHidden, parseUrl, readyStateIsComplete, removeStorageItem, reportSelfError, setStorageWithEncoding, setTraceContext, setVolTraceContext, syncReportWithCapturedContext, unloadSubject, uuid4, visibilityStateIsHidden };//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/integrations/node_modules/@slardar/sdk-web/dist/index.esm.js.map
