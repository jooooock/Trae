...
test('client.build - destroy but not started', function (t) {
    var client = createClient({
        builder: directBuilder,
        createSender: function () { return noopSender; },
        createDefaultConfig: function () { return ({}); },
    ...
    t.assert(onBuild.notCalled);
    client.init({});
    t.is(client.getPreStartQueue().length, 1);
    client.destroy();
    t.assert(onBuild.notCalled);
    t.is(client.getPreStartQueue().length, 0);
});
...
test('client.build - filter at build', function (t) {
    ...
    t.assert(send.calledOnce);
});//# sourceMappingURL=https://trae.private/sourcemaps/424b4bd987c6c6a4cadf1a08da420593cc6bf75a/node_modules/@slardar/integrations/node_modules/@slardar/sdk-template/esm/__tests__/client.build.spec.js.map